    ...
    >
      {({
        ...
        <S.Form id={formId} ref={formRef} onSubmit={handleSubmit}>
          {/* <input type="hidden" name="status" value="not-charged" data-cy={`checkoutPaymentGatewayDummyStatusnot-chargedLabel`} />
          <span
            data-cy={`checkoutPaymentGatewayDummyStatusnot-chargedLabel`}
          ></span> */}
          {/* <S.Status name="status" value="not-charged" /> */}
