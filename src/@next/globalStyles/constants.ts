...
export const turquoise = "#000";
export const turquoiseDark = "#999";
export const turquoiseLight = "#ccc";
export const turquoiseTransparent = "rgba(0, 0, 0, 0.1)";
export const white = "#fff";
export const tabelGray = "#eaeaea";
export const darkGreen = "#000";
